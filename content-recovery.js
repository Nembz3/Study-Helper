(()=>{
  ...
  function mount(a){
    ...
    root.innerHTML='<div class="sh-card"><div class="sh-head"><strong>Study Helper V4.2</strong><button class="sh-close">×</button></div><div class="sh-label"><span class="sh-type"></span> recovery detection</div><div class="sh-question"></div><div class="sh-actions"><button class="sh-hint">Hint</button><button class="sh-explain">Explain</button><button class="sh-answer">Quick answer</button></div><div class="sh-status"></div><div class="sh-response"></div><button class="sh-copy" hidden>Copy answer</button></div>';
